...
% chapters go here
\input{content/chapters/chapter1} % Introduction
\input{content/chapters/chapter2} % Background: ARC-AGI and the Measure of Intelligence
\input{content/chapters/chapter3} % Foundations: Core Knowledge, Program Synthesis, GP
\input{content/chapters/chapter4} % A Graph-Native Co-Evolutionary Solver
\input{content/chapters/chapter5} % Library Learning: Mining Reusable Macros
\input{content/chapters/chapter6} % Experimental Evaluation
\input{content/chapters/chapter7} % Towards ARC-AGI-3 and Conclusions
...
\phantom{0}
\cleardoublepage
% no \cite calls yet: \nocite{*} makes the whole bibliography visible in the
% skeleton. Remove it once the chapters cite their own sources.
\nocite{*}
