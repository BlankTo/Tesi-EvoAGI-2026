...
only on notions of objects, geometry, counting and space that developmental psychology
considers innate.

Because every task is new, no training distribution can be fitted. Humans average above
...
puzzle. The symbolic route is to search for a short program explaining the examples, which
